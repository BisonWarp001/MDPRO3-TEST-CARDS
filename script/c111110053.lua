--Priest of the Pharaoh's Cult terminado
local s,id=GetID()
function s.initial_effect(c)
	...
	e2:SetCountLimit(1,id) -- Comparten el ID del nombre para el HOPT
	e2:SetCost(s.thcost)
	e2:SetTarget(s.thtg)
	...
	e3:SetCountLimit(1,id) -- Una vez por turno cada efecto
