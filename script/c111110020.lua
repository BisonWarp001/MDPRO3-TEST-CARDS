...
function s.tkop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local max_by_atk=math.floor(atk/1000)
    local max=math.min(2, ft, max_by_atk)
    ...
    for i=1,ct do
        if Duel.IsPlayerCanSpecialSummonMonster(tp,111110021,0,TYPES_TOKEN,500,500,1,RACE_AQUA,ATTRIBUTE_WATER) then
