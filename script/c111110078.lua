...
function s.initial_effect(c)
	...
	-------------------------------------------------
	-- (1) On Summon: Special Summon 2 more Angels
	-------------------------------------------------
	...
	-------------------------------------------------
	-- (2) On Summon: Gain 1 Additional Normal Summon
	-------------------------------------------------
	...
	-------------------------------------------------
	-- (3) End Phase: Shuffle banished Spell/Trap -> Add to hand
	-------------------------------------------------
...
function s.sumop_extra(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetFlagEffect(tp,id)==0 then
		...
		e1:SetTarget(function(e,c) return c:IsCode(62180201,57793869,21208154) end)
...
-- Lógica (3) Barajar desterradas que mencionen a los Wicked Gods
function s.tdfilter(c)
	return c:IsFaceup() and c:IsType(TYPE_SPELL+TYPE_TRAP)
		and (aux.IsCodeListed(c,62180201) -- Dreadroot
		or aux.IsCodeListed(c,57793869)  -- Eraser
		or aux.IsCodeListed(c,21208154)) -- Avatar
		and c:IsAbleToDeck()
end
